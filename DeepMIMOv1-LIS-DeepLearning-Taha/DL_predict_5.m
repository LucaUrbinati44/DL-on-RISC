function [Rate_OPT,Rate_DL]=DL_predict_5(Mx,My,Mz,M_bar,Ur_rows,kbeams,Training_Size_dd,RandP_all,Validation_Ind)
...
%}
Rate_DL2 = mean(MaxR_DL);
Rate_OPT2 = mean(MaxR_OPT);
...
disp(['Rate_OPT2:', num2str(Rate_OPT2)]); % 1
disp(['Rate_DL:', num2str(Rate_DL)]); % 1
disp(['Rate_DL2:', num2str(Rate_DL2)]); % 1
