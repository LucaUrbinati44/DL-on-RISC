function []=Fig12_plot(My_ar,Mz_ar,M_bar,Ur_rows,Training_Size,...
    ...
    filename_fig12_py_test_tflite=strcat(figure_folder_py, 'Fig12_py_test_tflite', '_seed', num2str(seed), '_grid', num2str(Ur_rows(2)), '_M', strrep(num2str(My_ar), ' ', ''), strrep(num2str(Mz_ar), ' ', ''), '_Mbar', num2str(M_bar), '_', num2str(epochs), '.png');    
    ...
    if ishandle(f12)
        ...
        for rr=1:1:numel(My_ar)
            ...
            if epochs == 20
                ...
                plot((Training_Size*1e-3),Rate_DLt_py_test_20(rr,:),        [Colour(rr) Marker_test_20_40{rr, 1}],          'markersize',7,'linewidth',1.0, 'DisplayName', ['DL_{pyTest20      }, M = ' num2str(My_ar(rr))])
            ...
            elseif epochs == 40
                ...
                plot((Training_Size*1e-3),Rate_DLt_py_test_40(rr,:),        [Colour(rr) Marker_test_20_40{rr, 1}],          'markersize',7,'linewidth',1.0, 'DisplayName', ['DL_{pyTest40  }, M = ' num2str(My_ar(rr))])
                plot((Training_Size*1e-3),Rate_DLt_py_test_tflite_40(rr,:), [Colour(rr) Marker_test_20_40{rr, 2}],          'markersize',7,'linewidth',1.0, 'DisplayName', ['DL_{pyTest40  }, M = ' num2str(My_ar(rr))])
            ...
            elseif epochs == 60
                ...
                plot((Training_Size*1e-3),Rate_DLt_py_test_tflite_20(rr,:), [Colour_tflite(rr) Marker_test_tflite{rr, 1}],'markersize',7,'linewidth',1., 'DisplayName', ['DL_{pyTestTFLite20}, M = ' num2str(My_ar(rr))])
                plot((Training_Size*1e-3),Rate_DLt_py_test_tflite_40(rr,:), [Colour_tflite(rr) Marker_test_tflite{rr, 2}],'markersize',7,'linewidth',1., 'DisplayName', ['DL_{pyTestTFLite40}, M = ' num2str(My_ar(rr))])
                plot((Training_Size*1e-3),Rate_DLt_py_test_tflite_60(rr,:), [Colour_tflite(rr) Marker_test_tflite{rr, 3}],'markersize',7,'linewidth',1., 'DisplayName', ['DL_{pyTestTFLite60}, M = ' num2str(My_ar(rr))])
                disp('Rate_DLt_py_test_20(rr,:)')
                disp(Rate_DLt_py_test_20(rr,:))     
                disp('Rate_DLt_py_test_40(rr,:)')
                disp(Rate_DLt_py_test_40(rr,:)) 
