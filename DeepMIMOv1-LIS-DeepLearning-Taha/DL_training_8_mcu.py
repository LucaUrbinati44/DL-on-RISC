...
#datetime_str = datetime.datetime.now().strftime("experiment-23-10-25-xxxxx") # M3232_M_bar=28

datetime_str = datetime.datetime.now().strftime("experiment" + '_M' + str(My) + str(Mz) + '_Mbar' + str(active_cells[0]))
initial_epoch = 200 # se vuoi continuare un allenamento, sono le epoche dalle quali ripartire
