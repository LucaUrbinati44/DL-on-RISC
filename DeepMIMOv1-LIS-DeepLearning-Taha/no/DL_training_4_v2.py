...
def dl_training_4(seed, DL_input_reshaped, DL_output_reshaped, training_size, validation_size, mini_batch_size=500, max_epochs=20, use_gpu=True):
    """
...
if __name__ == "__main__":
    ...
    model, history, Y_predicted = dl_training_4(seed, DL_input_reshaped, DL_output_reshaped, training_size, validation_size)
