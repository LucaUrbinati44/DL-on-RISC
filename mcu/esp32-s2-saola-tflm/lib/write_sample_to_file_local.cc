...
const std::string kOutputFilePath = "/mnt/c/Users/Work/Desktop/deepMIMO/RIS/renode_boards/litex-vexriscv-tensorflow-lite-demo/renode/output_local_codebook_small.data";
