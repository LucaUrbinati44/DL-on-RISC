...
% Date: Sept. 5, 2018 
s% Goal: Encouraging research on ML/DL for mmWave/massive MIMO applications and
...
% System bandwidth
params.bandwidth=0.1;                % The bandiwdth in GHz 
...
params.filename="M"+num_ant_y+"L"+num_paths;
